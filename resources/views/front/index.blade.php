    ...
    <li class="nav-item h5">
     <a class="nav-link" href="about-us.html">ثبت نام</a>
                ...
                <div class="d-flex flex-column justify-content-center align-items-center">
                    <img class="offcanvas-avatar avatar-img p-1 mb-2" src="{{ Vite::image('avatar/morteza.jpeg') }}"
                        alt="">
                    <p class="fw-bold" style="font-size: 17px;">Morteza Maleki </p>
                ...
                <div class="my-4">
                    <ul class="nav d-flex flex-column offcanvas-dash-nav">
                        <li class="nav-item my-1 bg-light"><a class="nav-link" style="font-size: 17px;" href=""
                                data-bs-toggle="offcanvas" data-bs-target="#offcanvas‌Profile">پروفایل</a></li>
                        <li class="nav-item my-1 bg-light"><a class="nav-link" style="font-size: 17px;" href=""
                                data-bs-toggle="offcanvas" data-bs-target="#offcanvas‌Bookmark">علاقه مندی ها</a></li>
                        <li class="nav-item my-1 bg-light"><a class="nav-link" style="font-size: 17px;"
                                href="">همه مقالات</a></li>
                        <li class="nav-item my-1 bg-light"><a class="nav-link" style="font-size: 17px;"
                                href="dashboard.html">داشبورد</a></li>
                        <li class="nav-item my-1 bg-light"><a class="nav-link" style="font-size: 17px;"
                                href="">افزودن مقاله</a></li>
                        <li class="nav-item my-1 bg-light"><a class="nav-link" style="font-size: 17px;"
                                href="">ویرایش مقالات</a></li>
                        <li class="nav-item my-1 bg-light"><a class="nav-link" style="font-size: 17px;"
                                href="">مدیریت دیدگاه ها</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="nav-item dropdown position-relative">
                        ...
                        <a class="nav-link dropdown-toggle notif-dropdown-toggle p-2" href="#" id="pagesMenu"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
                                class="bi bi-bell" style="font-size: 23px;"></i></a>
                            ...
                            <div class="card card-overlay-bottom card-grid-lg card-bg-scale">
                                ...
                                <div class="card-img-overlay">
                                    <div class="w-100 h-100 position-relative">
                                        ...
                                        <!-- Card category -->
                                        <a href="#"
                                            class="badge text-bg-success mb-2 position-absolute end-0 "><i
                                        ...
                                        <div class="text-white position-absolute" style="bottom: 57px;right: 13px;">
                                            <div class="avatar avatar-sm">
                                                <img class="avatar-img rounded-circle"
                                                    src="{{ Vite::image('avatar/morteza.jpeg') }}" alt="avatar">
                                            </div>
                                            <span class="ms-1"><a href="#"
                                                    class="stretched-link text-reset btn-link"> Morteza
                                                    Maleki</a></span>
                                        </div>
                                        <h2
                                ...
                                <div class="card-img-overlay">
                                    <div class="w-100 h-100 position-relative">
                                        ...
                                        <div class="text-white position-absolute" style="bottom: 57px;right: 13px;">
                                            ...
                                            <span class="ms-1"><a href="#"
                                                    class="stretched-link text-reset btn-link">Morteza Maleki
                                                </a></span>
                                        </div>
                                        <h2
                                            class="w-100 rounded px-3 py-3 slider-topic-title position-absolute bottom-0">
                ...
                <div class="row">
                    <div class="swiper-cats" dir="rtl">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide  ">
                                <div class=""><a href=""
                                        class="text-center py-3 px-1 d-block btn btn-light"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 card mb-3">
                        <div class="d-flex p-3"
                            ...
                            <img class="rounded w-25" src="{{ Vite::image('blog/4by3/thumb/01.jpg') }}"
                                alt="">
                            ...
                            <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                                <div class="w-100 mt-auto">
                                    ...
                                    <h2 class="text-white h1"><a href="post-single-4.html"
                                            class="btn-link stretched-link text-reset">ده نشانه که نشان می دهد برای راه
                                            اندازی
                                        ...
                                        <li class="nav-item">
                                            <div class="nav-link">
                                                <div class="d-flex align-items-center text-white position-relative">
                                                    <div class="avatar avatar-sm">
                                                        <img class="avatar-img rounded-circle"
                                                            src="{{ Vite::image('avatar/morteza.jpeg') }}"
                                                            alt="avatar">
                                                    </div>
                                    ...
                                    <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                                        <div class="w-100 mt-auto">
                                            ...
                                            <h4 class="text-white"><a href="post-single-4.html"
                                                    class="btn-link stretched-link text-reset">بهترین تابلوهای
                                                    Pinterest برای
                                            ...
                                            <ul
                                                ...
                                                <li class="nav-item position-relative">
                                                    <div class="nav-link"><a href="#"
                                                            class="stretched-link text-reset btn-link">مهدی راد</a>
                                                    </div>
                                                </li>
                                ...
                                <div class="card card-overlay-bottom card-grid-sm card-bg-scale"
                                    ...
                                    <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                                        <div class="w-100 mt-auto">
                                            ...
                                            <!-- Card title -->
                                            <h4 class="text-white"><a href="post-single-4.html"
                                                    class="btn-link stretched-link text-reset">دلیل کاهش نرخ دلار </a>
                                            </h4>
                                            <!-- Card info -->
                                            <ul
                                                class="nav nav-divider text-white-force align-items-center d-none d-sm-inline-block">
                                                <li class="nav-item position-relative">
                                                    <div class="nav-link"><a href="#"
                                                            class="stretched-link text-reset btn-link">مسعود خالدی</a>
                                                    </div>
                                                </li>
                                ...
                                <div class="card card-overlay-bottom card-grid-sm card-bg-scale"
                                    ...
                                    <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                                        <div class="w-100 mt-auto">
                                            ...
                                            <!-- Card title -->
                                            <h4 class="text-white"><a href="post-single-4.html"
                                                    class="btn-link stretched-link text-reset">جدول لیگ در پایان
                                                    هفته</a></h4>
                                            <!-- Card info -->
                                            <ul
                                                class="nav nav-divider text-white-force align-items-center d-none d-sm-inline-block">
                                                <li class="nav-item position-relative">
                                                    <div class="nav-link"><a href="#"
                                                            class="stretched-link text-reset btn-link">شادی اسدی</a>
                                                    </div>
                                                </li>
                ...
                <div class="swiper" dir="rtl">
                    ...
                    <div class="swiper-wrapper p-3">
                        ...
                        <div class="swiper-slide py-5">
                            <div class="card bg-lights p-4"
                                style="box-shadow: 0px 5px 20px 0px rgba(69, 67, 96, 0.1);">
                                <!-- Card img -->
                                ...
                                <div class="card-body px-0 pt-3">
                                    ...
                                    <h4 class="card-title mt-2"><a href="post-single.html"
                                            class="btn-link text-reset">فیلم‌های بالیوودی الگوی
                                            ضدانقلاب شده!</a></h4>
                                    <p class="card-text">ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز
                        ...
                        <div class="swiper-slide py-5">
                            <div class="card bg-lights p-4"
                                ...
                                <div class="card-body px-0 pt-3">
                                    ...
                                    <h4 class="card-title mt-2"><a href="post-single.html"
                                            class="btn-link text-reset">فیلم‌های
                                            بالیوودی الگوی
                                            ضدانقلاب شده!</a></h4>
                                    <p class="card-text">ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز
                                        شامل
                        ...
                        <div class="tiny-slider arrow-hover arrow-blur arrow-dark arrow-round">
                            <div class="tiny-slider-inner" style="float: left" data-autoplay="true"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body px-0 pt-3">
                                        <h5 class="card-title"><a href="post-single-3.html"
                                                class="btn-link text-reset">افزایش آلودگی هوا در شهرهای پُرجمعیت تا
                                                فردا</a></h5>
                                        <!-- Card info -->
                                        <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
                                            <li class="nav-item">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body px-0 pt-3">
                                        <h5 class="card-title"><a href="post-single-3.html"
                                                class="btn-link text-reset">آمار فرزندان حاصل از روش‌های کمک‌ باروری در
                                                جهان</a></h5>
                                        <!-- Card info -->
                                        <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
                                            <li class="nav-item">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body px-0 pt-3">
                                        <h5 class="card-title"><a href="post-single-3.html"
                                                class="btn-link text-reset">عادات بدی که افراد در صنعت باید آنها را ترک
                                                کنند!</a></h5>
                                        <!-- Card info -->
                                        <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
                                            <li class="nav-item">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body px-0 pt-3">
                                        <h5 class="card-title"><a href="post-single-3.html"
                                                class="btn-link text-reset">به همین دلیل امسال سال استارت آپ ها خواهد
                                                بود؟</a></h5>
                                        <!-- Card info -->
                                        <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
                                            <li class="nav-item">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body px-0 pt-3">
                                        <h5 class="card-title"><a href="post-single-3.html"
                                                class="btn-link text-reset">بهترین تابلوهای پینترست برای یادگیری در
                                                مورد تجارت</a></h5>
                                        <!-- Card info -->
                                        <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
                                            <li class="nav-item">
        ...
        <div class="container pt-5 ">
            ...
            <div class="row pt-5">
                ...
                <div class="col-md-6 col-lg-3 mb-4">
                    ...
                    <div class="mb-4 position-relative">
                        <div><a href="#" class="badge text-bg-danger mb-2"><i
                                    class="fas fa-circle me-2 small fw-bold"></i>اقتصاد</a></div>
                        <a href="post-single-3.html" class="btn-link text-white fw-normal">تقویم آزمون‌های علوم
                            پزشکی</a>
                        <ul class="nav nav-divider align-items-center small mt-2 text-body-secondary">
                            <li class="nav-item position-relative">
                                <div class="nav-link"><a href="#"
                                        class="stretched-link text-reset btn-link">نازنین لطفی</a>
                                </div>
                            </li>
                    ...
                    <!-- Item -->
                    <div class="mb-4 position-relative">
                        <div><a href="#" class="badge text-bg-info mb-2"><i
                                    class="fas fa-circle me-2 small fw-bold"></i>فرهنگ</a></div>
                        <a href="post-single-3.html" class="btn-link text-white fw-normal">احتمال آغاز موج هشتم
                            کرونا در کشور</a>
                        <ul class="nav nav-divider align-items-center small mt-2 text-body-secondary">
                            <li class="nav-item position-relative">
                                <div class="nav-link"><a href="#"
                                        class="stretched-link text-reset btn-link">وحید صالحی</a>
                                </div>
                            </li>
                ...
                <div class="col-sm-6 col-lg-3 mb-4">
                    ...
                    <div class="row g-2">
                        <div class="col">
                            <a href="#"><img class="w-100" src="{{ Vite::image('app-store.svg') }}"
                                    alt="app-store"></a>
                        </div>
                        <div class="col">
                    ...
                    <div class="col-md-4 d-flex align-items-center justify-content-center justify-content-md-end">
                        ...
                        <ul class="nav d-flex flex-row-reverse justify-content-between align-items-end ">
                            <li class="nav-item"><a class="nav-link pt-0" href="#"><i
                                        class="fab fa-telegram fa-fw me-2" style="font-size: 22px;"></i></a></li>
                            <li class="nav-item"><a class="nav-link pt-0" href="#"><i
                                        class="fab fa-instagram fa-fw me-2" style="font-size: 22px;"></i></a>
                            </li>
                            <li class="nav-item"><a class="nav-link pt-0" href="#"><i
                                        class="fab fa-whatsapp fa-fw me-2" style="font-size: 22px;"></i></a></li>
                            <li class="nav-item"><a class="nav-link pt-0" href="#"><i
                                        class="fab fa-twitter fa-fw me-2" style="font-size: 22px;"></i></a></li>
                            <li class="nav-item"><a class="nav-link pt-0" href="#"><i
                                        class="fab fa-linkedin fa-fw me-2" style="font-size: 22px;"></i></a></li>
                            <li class="nav-item"><a class="nav-link pt-0" href="#"><i
                                        class="fab fa-youtube fa-fw me-2" style="font-size: 22px;"></i></a></li>
                        </ul>
                    </div>
...
Footer END -->
   ...
   <ul class="nav p-2">
    ...
    <a href="" class="nav-link"><li class="nav-item d-flex"><i class="bi bi-box-arrow-in-left me-1" style="font-size: 18px;"></i>ورود - ثبت نام</li></a>
     ...
     <div>
      <div class="card bg-lights p-4" style="box-shadow: 0px 5px 20px 0px rgba(69, 67, 96, 0.1);">
       ...
       <div class="position-relative placeholder-glow">
        <span class="placeholder card-img col-12 " style="margin-top: -80px;height: 200px;"></span>
        <img class="card-img d-none" style="margin-top: -80px;" src="{{ Vite::image('blog/4by3/01.jpg') }}" alt="Card image">
        <div class="card-img-overlay d-flex align-items-start flex-column p-3">
         <!-- Card overlay bottom -->
         <div class="w-100 mt-auto">
          <!-- Card category -->
       ...
       <div class="card-body px-0 pt-3">
        <!-- Sponsored Post -->
        <h4 class="card-title mt-2 placeholder-glow"><a href="post-single.html" class="btn-link text-reset">
          </a>
        ...
        <ul class="nav d-flex align-items-center align-items-center">
         <li class="nav-item">
           <div class="position-relative">
            <div class="placeholder-glow d-flex justify-content-center align-items-center">
             <img class="avatar-img avatar-xs rounded-circle d-none" src="{{ Vite::image('avatar/morteza.jpeg') }}" alt="avatar">
             <span class="placeholder  placeholder-lg rounded-circle" style="width: 40px; height: 40px;"></span>
           </div>
          </div>
         </li>
         ...
         <li class="nav-item placeholder-glow"><span class="placeholder " style="width: 80px;"></span></li>
        </ul>
       </div>
      </div>
     </div>
    ...
    <div>
     <div class="card bg-lights p-4" style="box-shadow: 0px 5px 20px 0px rgba(69, 67, 96, 0.1);">
      ...
      <div class="card-body px-0 pt-3">
       ...
       <h4 class="card-title mt-2"><a href="post-single.html" class="btn-link text-reset">فیلم‌های بالیوودی
         الگوی
         ضدانقلاب شده!</a></h4>
       <p class="card-text">ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز شامل .</p>
       <!-- Card info -->
       <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
        <li class="nav-item">
         <div class="nav-link">
          <div class="d-flex align-items-center position-relative">
           <div class="avatar avatar-xs">
            <img class="avatar-img rounded-circle" src="{{ Vite::image('avatar/morteza.jpeg') }}"
             alt="avatar">
           </div>
           <span class="ms-3"><a href="#"
             class="stretched-link text-reset btn-link"> Morteza Maleki</a></span>
          </div>
         </div>
        </li>
        <li class="nav-item">22 آذر، 1400</li>
     ...
     <div class="card bg-lights p-4" style="box-shadow: 0px 5px 20px 0px rgba(69, 67, 96, 0.1);">
      ...
      <div class="card-body px-0 pt-3">
       ...
       <h4 class="card-title mt-2"><a href="post-single.html" class="btn-link text-reset">فیلم‌های بالیوودی
         الگوی
         ضدانقلاب شده!</a></h4>
       <p class="card-text">ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز شامل حروفچینی
        دستاوردهای
        اصلی
        و جوابگوی سوالات پیوسته اهل دنیای طراحی اساسا مورد.و جوابگوی سوالات پیوسته اهل دنیای طراحی اساسا
          ...
          <div class="col-sm-12 col-md-auto text-center text-md-start">
           <div class="avatar avatar-xxl mt-n5">
            <img class="avatar-img rounded-circle border border-white border-3 shadow"
             src="{{ Vite::image('avatar/04.jpg') }}" alt="">
           </div>
          </div>
          <!-- Profile info -->
          <div
       ...
       <div class="card border mb-4">
        ...
        <div class="card-body">
         ...
         <div class="mb-3">
          ...
          <textarea class="form-control" rows="10" cols="10" style="min-height: 300px;">من راهی برای دریافت پول برای سرگرمی مورد علاقه‌ام پیدا کرده‌ام و این کار را در حالی انجام می‌دهم که رویای سفر به دور دنیا را دنبال می‌کنم.</textarea>
