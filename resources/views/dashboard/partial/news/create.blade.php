            ...
            <form>
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <div class="mb-3">
                    ...
                    <input required id="con-name" name="name" type="text" class="form-control" placeholder="عنوان خبر">
              ...
              <div class="col-12">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" rows="3" placeholder="توضیح مختصری را درباره خبر بنویسید..."></textarea>
                </div>
              </div>
