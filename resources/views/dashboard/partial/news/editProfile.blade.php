    ...
    <div class="row g-4">
      ...
      <div class="col-12">
        <div class="card mb-4 position-relative z-index-9">
          <!-- Cover image -->
          <div class="py-5 h-200 rounded" style="background-image:url({{ Vite::image('blog/16by9/big/07.jpg')}}); background-position: center bottom; background-size: cover; background-repeat: no-repeat;">
          </div>
            ...
            <div class="row d-flex justify-content-between">
              ...
              <div class="col-sm-12 col-md-auto text-center text-md-start">
                <div class="avatar avatar-xxl mt-n5">
                  <img class="avatar-img rounded-circle border border-white border-3 shadow" src="{{ Vite::image('avatar/03.jpg') }}" alt="">
                </div>
              </div>
              <!-- Profile info -->
            ...
            <div class="card border mb-4">
              ...
              <div class="card-body">
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <input class="form-control fakepassword" type="password" id="psw-input" placeholder="*********">
